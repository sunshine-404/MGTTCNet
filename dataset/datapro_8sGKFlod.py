...
np.save(file="/root/autodl-tmp/dataset_GKF/data8s.npy",arr=data_array)
data_array=np.load(file="/root/autodl-tmp/dataset_GKF/data8s.npy")

np.save(file="/root/autodl-tmp/dataset_GKF/label8s.npy",arr=label_array)
label_array=np.load(file="/root/autodl-tmp/dataset_GKF/label8s.npy")

np.save(file="/root/autodl-tmp/dataset_GKF/group8s.npy",arr=group_array)
group_array=np.load(file="/root/autodl-tmp/dataset_GKF/group8s.npy")

print(data_array.shape,label_array.shape,group_array.shape)

# np.save(file="/root/autodl-tmp/dataset04/data4s.npy",arr=data_array)
# data_array=np.load(file="/root/autodl-tmp/dataset04/data4s.npy")
#
# np.save(file="/root/autodl-tmp/dataset04/label4s.npy",arr=label_array)
# label_array=np.load(file="/root/autodl-tmp/dataset04/label4s.npy")
#
# np.save(file="/root/autodl-tmp/dataset04/group4s.npy",arr=group_array)
# group_array=np.load(file="/root/autodl-tmp/dataset04/group4s.npy")
#
# print(data_array.shape,label_array.shape,group_array.shape)